...
vim.keymap.set(
  "n",
  "<leader>nsm",
  "0oprivate function (): void<esc>o{<esc>o}<esc>kk0wwwi",
  { noremap = true, silent = true }
)
...
vim.keymap.set(
  "n",
  "<leader>npm",
  "0oprotected function (): void<esc>o{<esc>o}<esc>kk0wwwi",
  { noremap = true, silent = true }
)
...
vim.keymap.set(
  "n",
  "<leader>ncm",
  "0opublic function (): void<esc>o{<esc>o}<esc>kk0wwwi",
  { noremap = true, silent = true }
)
...
vim.keymap.set(
  "n",
  "<leader>ecc",
  ":edit /home/darling/manuallyInstalledBinaries/nvim-linux64/share/nvim/runtime/colors/darling.vim<CR>",
  { noremap = true, silent = true }
)
