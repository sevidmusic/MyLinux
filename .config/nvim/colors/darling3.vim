...
let s:colors = {}
let s:colors.base0 = {'cterm': 0 } " Background color
let s:colors.base5 = {'cterm': 1 }
let s:colors.orange  = {'cterm': 2 } " Effects: Brackets, values, misc keywords
let s:colors.cyan    = {'cterm': 3 }
let s:colors.base4 = {'cterm': 4 }
let s:colors.base6 = {'cterm': 5 }
let s:colors.base3 = {'cterm': 6 }
let s:colors.base1 = {'cterm': 235 } " Row and coloumn colors
let s:colors.magenta = {'cterm': 8 }
let s:colors.violet  = {'cterm': 9 }
let s:colors.base2 = {'cterm': 10 }
let s:colors.red     = {'cterm': 12 } " Effects: Error bg color, `use`, @.*
let s:colors.yellow  = {'cterm': 13 }
let s:colors.green   = {'cterm': 14 }
let s:colors.blue    = {'cterm': 15 } " Effects: Comments
let s:colors.base7 = {'cterm': 16 } " Effects: Error fg color
