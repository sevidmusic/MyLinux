...
nnoremap <leader>l1 `1zt<esc>
nnoremap <leader>l2 `2zt<esc>
nnoremap <leader>l3 `3zt<esc>
nnoremap <leader>l4 `4zt<esc>
nnoremap <leader>l5 `5zt<esc>
nnoremap <leader>l6 `6zt<esc>
nnoremap <leader>l7 `7zt<esc>
nnoremap <leader>l8 `8zt<esc>
nnoremap <leader>l9 `9zt<esc>
